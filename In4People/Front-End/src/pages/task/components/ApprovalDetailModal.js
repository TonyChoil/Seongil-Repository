...
function ApprovalDetailModal() {
    ...
    return (
        <>
            <div className="modal fade modal-dialog-scrollable " id="approvalDetail" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel">
