...
function ApprovalSubmit() {
    ...
    const onclickDetailHandler = (docCode) => {
        console.log('clicked1',docCode);
        dispatch(callApprovalDetailAPI(docCode));
                                        ...
                                        <div className={`${NavCSS["sc-djTcra"]} ${NavCSS["laubHy"]}`}>
                                            <div className={`${NavCSS["form-group"]}`}>
                                                ...
                                                <div className={`${NavCSS["position-relative"]}`}>
                                                    <input value={form.startDate} ref={startDate} type="date" name="startDate" className={`${NavCSS["sc-fWHiwC"]} ${NavCSS["jtuvXR"]} ${NavCSS["form-control"]} ${NavCSS["input-datepicker"]}`} placeholder="시작일"
                                            ...
                                            <div className={`${NavCSS["form-group"]}`}>
                                                ...
                                                <div className={`${NavCSS["position-relative"]}`}>
                                                    <input value={form.endDate} ref={endDate} type="date" name="endDate" className={`${NavCSS["sc-fWHiwC"]} ${NavCSS["jtuvXR"]} ${NavCSS["form-control"]} ${NavCSS["input-datepicker"]}`} placeholder="시작일"
                                                     onChange={onChangeCalendarHandler} />
                                                </div>
                                            </div>
                                            ...
                                            <tbody>
                                                {
                                                    Array.isArray(approvalList) && approvalList.map((a) => (
                                                        <tr key={a.docCode} onClick={() => onclickDetailHandler(a.docCode)}>
                                                            <td>
                                                ...
                                                <button id="detailModal" style={{display: "none"}} data-bs-toggle="modal" data-bs-target="#approvalDetail"/>
                                                <ApprovalDetailModal />
                                            </tbody>
                                        </table>
